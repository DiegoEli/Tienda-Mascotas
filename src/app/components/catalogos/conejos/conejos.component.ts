...
export class ConejosComponent {
  ...
  constructor(){
    this.listaProductosConejos = [
      ...
      idCategoria: 1, precioVenta: 5.60, stock: 20, urlFoto: "./assets/img/prod-conejos/C0002.png"},
      {idProducto: 1002, nombre: "Juguete Ferplast Goodb Nat Bag Carrot", descripcion: "Juguete para mordisquear para roedores",
      idCategoria: 1, precioVenta: 4.30, stock: 25, urlFoto: "./assets/img/prod-conejos/C0003.png"},
